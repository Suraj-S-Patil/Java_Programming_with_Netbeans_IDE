 ...
 * @author TEACHER
 */
public class Method_5 extends javax.swing.JFrame {

    /**
     * Creates new form Method_5
     */
    public Method_5() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("I+II+III");

        jLabel6.setText("I+II");

        jLabel7.setText("I+II+IV");
...
int tot1=add(s1,s2,s3);
int tot2=add(s1,s2);
float tot3=add(s1,s2,s4);
jTextField5.setText(""+tot1);
jTextField6.setText(""+tot2);
jTextField7.setText(""+tot3);
...
float add(int a,int b,float d)
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Method_5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
